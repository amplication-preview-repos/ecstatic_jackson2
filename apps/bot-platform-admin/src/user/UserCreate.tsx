...
import { LanguageSettingTitle } from "../languageSetting/LanguageSettingTitle";
  ...
  return (
    <Create {...props}>
      <SimpleForm>
        ...
        <ReferenceArrayInput
          source="languageSettings"
          reference="LanguageSetting"
          parse={(value: any) => value && value.map((v: any) => ({ id: v }))}
          format={(value: any) => value && value.map((v: any) => v.id)}
        >
          <SelectArrayInput optionText={LanguageSettingTitle} />
        </ReferenceArrayInput>
