...
import { LanguageSettingFindManyArgs } from "../../languageSetting/base/LanguageSettingFindManyArgs";
import { LanguageSetting } from "../../languageSetting/base/LanguageSetting";
...
export class UserControllerBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @common.Get("/:id/languageSettings")
  ...
  async findLanguageSettings(
    @common.Req() request: Request,
    @common.Param() params: UserWhereUniqueInput
  ): Promise<LanguageSetting[]> {
    const query = plainToClass(LanguageSettingFindManyArgs, request.query);
    const results = await this.service.findLanguageSettings(params.id, {
      ...query,
      select: {
        createdAt: true,
        id: true,
  ...
  @common.Post("/:id/languageSettings")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async connectLanguageSettings(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: LanguageSettingWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      languageSettings: {
        connect: body,
  ...
  @common.Patch("/:id/languageSettings")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  ...
  @common.Delete("/:id/languageSettings")
  @nestAccessControl.UseRoles({
    resource: "User",
    action: "update",
    possession: "any",
  })
  async disconnectLanguageSettings(
    @common.Param() params: UserWhereUniqueInput,
    @common.Body() body: LanguageSettingWhereUniqueInput[]
  ): Promise<void> {
    const data = {
