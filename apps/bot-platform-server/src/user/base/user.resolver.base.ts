...
export class UserResolverBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [CrmData], { name: "crmDataItems" })
  @nestAccessControl.UseRoles({
    resource: "CrmData",
    action: "read",
    possession: "any",
  ...
  async findCrmDataItems(
    ...
    const results = await this.service.findCrmDataItems(parent.id, args);
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => [LanguageSetting], { name: "languageSettings" })
  @nestAccessControl.UseRoles({
  ...
  async findLanguageSettings(
    ...
    const results = await this.service.findLanguageSettings(parent.id, args);
