...
@InputType()
class LanguageSettingCreateNestedManyWithoutUsersInput {
...
export { LanguageSettingCreateNestedManyWithoutUsersInput as LanguageSettingCreateNestedManyWithoutUsersInput };
